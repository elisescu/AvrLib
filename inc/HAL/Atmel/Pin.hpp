...
class WithPinChange: public base, public PinChangeInterrupt<typename info::pcintInfo, info::pcintBit> {
public:
	using base::base;
};

template <typename base, typename info>
class WithPinChangeOnChange: public base, public PinChangeInterruptOnChange<typename info::pcintInfo, info::pcintBit> {
public:
	using base::base;
};
