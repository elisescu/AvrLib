...
>
struct StreamedSizeReading<Register8<_addr, _bit0, _bit1, _bit2, _bit3, _bit4, _bit5, _bit6, _bit7>>: public FixedSize<1> {};
...
template <
  ...
  template<typename, uint8_t> class _bit7
>
struct StreamedSizeWriting<Register8<_addr, _bit0, _bit1, _bit2, _bit3, _bit4, _bit5, _bit6, _bit7>>: public FixedSize<1> {};
